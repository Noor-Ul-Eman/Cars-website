...
const Home = () => {
    ...
    const vehicleCategories = [
        { name: 'SUV', count: '320,875 Ads', image: 'https://images.unsplash.com/photo-1519245659620-e859806a8d3b?w=400&h=260&fit=crop&auto=format' },
        { name: 'Sedan', count: '2,543,210 Ads', image: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=400&h=260&fit=crop&auto=format' },
        { name: 'Hatchback', count: '850,432 Ads', image: 'https://images.unsplash.com/photo-1471444928139-48c5bf5173f8?w=400&h=260&fit=crop&auto=format' },
        { name: 'Luxury', count: '95,007 Ads', image: 'https://images.unsplash.com/photo-1614162692292-7ac56d7f7f1e?w=400&h=260&fit=crop&auto=format' },
        { name: 'Electric', count: '150,432 Ads', image: 'https://images.unsplash.com/photo-1560958089-b8a1929cea89?w=400&h=260&fit=crop&auto=format' },
        { name: 'Sports', count: '95,007 Ads', image: 'https://images.unsplash.com/photo-1592198084033-aade902d1aae?w=400&h=260&fit=crop&auto=format' },
        { name: 'Pickup & Truck', count: '45,382 Ads', image: 'https://images.unsplash.com/photo-1570733577524-3a047079e80d?w=400&h=260&fit=crop&auto=format' },
        { name: 'Coupe', count: '42,618 Ads', image: 'https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?w=400&h=260&fit=crop&auto=format' },
        { name: 'Convertible', count: '28,541 Ads', image: 'https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=400&h=260&fit=crop&auto=format' },
        { name: 'Minivan', count: '67,129 Ads', image: 'https://images.unsplash.com/photo-1563720223185-11003d516935?w=400&h=260&fit=crop&auto=format' },
        { name: 'Classic', count: '18,920 Ads', image: 'https://images.unsplash.com/photo-1603386329225-868f9b1ee6c9?w=400&h=260&fit=crop&auto=format' },
        { name: 'Off-Road', count: '35,774 Ads', image: 'https://images.unsplash.com/photo-1559416523-140ddc3d238c?w=400&h=260&fit=crop&auto=format' },
        { name: 'Wagon', count: '80,219 Ads', image: 'https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=400&h=260&fit=crop&auto=format' },
        { name: 'Cabriolet', count: '8,302 Ads', image: 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?w=400&h=260&fit=crop&auto=format' },
        { name: 'Hybrid', count: '92,441 Ads', image: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=400&h=260&fit=crop&auto=format' },
        { name: 'Commercial', count: '35,774 Ads', image: 'https://images.unsplash.com/photo-1616422285623-13ff0162193c?w=400&h=260&fit=crop&auto=format' },
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans">
            ...
            <div className="pt-48 pb-12 bg-[#F3F5F9]">
            ...
            {/* Vehicle Categories */}
            <div className="bg-[#F3F5F9] pt-4 pb-10">
                <div className="max-w-5xl mx-auto px-4">
                    <div className="text-center mb-8">
                        <h3 className="text-3xl font-bold text-gray-900">Browse by Category</h3>
                        <p className="text-gray-500 mt-2 text-sm">Find the perfect body type for your lifestyle</p>
                    </div>
                    <div className="bg-white rounded-2xl shadow-xl p-6 border border-gray-100">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {vehicleCategories.map((car, index) => (
                                <button
                                    key={index}
                                    className="bg-gray-50 rounded-2xl overflow-hidden hover:shadow-md transition-all duration-200 group text-left border border-gray-100 hover:border-primary-200"
                                >
                                    <div className="overflow-hidden rounded-xl m-2">
                                        <img
                                            src={car.image}
                                            alt={car.name}
                                            className="w-full h-28 object-cover group-hover:scale-105 transition-transform duration-300 rounded-xl"
                                        />
                                    </div>
                                    <div className="px-3 pb-3 pt-1">
                                        <p className="font-bold text-gray-900 text-sm">{car.name}</p>
                                        <p className="text-xs text-primary-600 font-medium mt-0.5">{car.count}</p>
                                    </div>
                                </button>
                            ))}
                        </div>
